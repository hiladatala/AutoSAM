...
def unet_3d(input_size=(128, 128, 128, 1)):
    ...
    # Encoder: Down-sampling path (contracting)
    ...
    # Decoder: Up-sampling path (expanding)
    u6 = layers.Conv3DTranspose(256, (3, 3, 3), strides=(2, 2, 2), padding='same')(c5)
    ...
    u7 = layers.Conv3DTranspose(128, (3, 3, 3), strides=(2, 2, 2), padding='same')(c6)
    ...
    u8 = layers.Conv3DTranspose(64, (3, 3, 3), strides=(2, 2, 2), padding='same')(c7)
    u8 = layers.concatenate([u8, c2])
    c8 = layers.Conv3D(64, (3, 3, 3), activation='relu', padding='same')(u8)
    c8 = layers.Conv3D(64, (3, 3, 3), activation='relu', padding='same')(c8)

    u9 = layers.Conv3DTranspose(32, (3, 3, 3), strides=(2, 2, 2), padding='same')(c8)
